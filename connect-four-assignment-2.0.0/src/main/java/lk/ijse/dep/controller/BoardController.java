...
public class BoardController  implements BoardUI {
    ...
    private void colOnClick(VBox col) {
        ...
        System.out.println(grpCols.getChildren().indexOf(col));
    ...
    public void notifyWinner(Winner winner) {
        isGameOver = true;
        System.out.println(winner.getWinningPiece()+"  row :"+winner.getRow1());
        System.out.println(winner.getWinningPiece()+"  row2 :"+winner.getRow2());
        System.out.println(winner.getWinningPiece()+"  col :"+winner.getCol1());
        System.out.println(winner.getWinningPiece()+"  col2 :"+winner.getCol2());
